...
public final class NotificationPanelViewController implements ShadeSurface, Dumpable {
    ...
    void flingToHeight(float vel, boolean expand, float target,
        ...
        if (expand) {
            ...
            mFlingAnimationUtils.apply(animator, mExpandedHeight, target + overshootAmount * mPanelFlingOvershootAmount, vel, this.mView.getHeight());
            if (vel == 0) {
            ...
            if (shouldUseDismissingAnimation()) {
                if (vel == 0) {
                    ...
                    long duration = 200L + (long) (mExpandedHeight / this.mView.getHeight() * 100);
