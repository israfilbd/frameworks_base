    ...
    override fun applyConstraints(constraintSet: ConstraintSet) {
        ...
        constraintSet.apply {
            ...
            when {
                ...
                constraintSet.getConstraint(sharedR.id.date_smartspace_view) != null -> {
                    connect(R.id.keyguard_info_widgets, ConstraintSet.TOP, sharedR.id.date_smartspace_view, ConstraintSet.BOTTOM, 12)
                }
                else -> {
                    connect(
