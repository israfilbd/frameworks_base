...
public class IdleManager {
    ...
    private static final String ACTION_SCAN = "com.android.systemui.infinity.ACTION_IDLE_SCAN";
    private static final String ACTION_HALT = "com.android.systemui.infinity.ACTION_IDLE_HALT";
    ...
    @Nullable
    public static IdleManager getInstance() { return sInstance; }
    ...
    public void cleanup() {
        ...
        Log.d(TAG, "IdleManager cleaned up");
    }
    ...
    private void performIdleScan() {
        ...
        for (Map.Entry<String, AppConfig> entry : mAppConfigCache.entrySet()) {
            ...
            if (IdleConstants.PROTECTED_PACKAGES.contains(pkg)) {
