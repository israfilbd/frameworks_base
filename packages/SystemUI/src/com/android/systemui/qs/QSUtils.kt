...
object QSUtils {
    ...
    @JvmStatic
    fun isOosQsLayoutEnabled(context: Context): Boolean {
        return (Settings.System.getIntForUser(context.contentResolver, 
            Settings.System.OOS_QS_STYLE, 0, UserHandle.USER_CURRENT) != 0) &&
            context.resources.getBoolean(R.bool.qs_op_media_player_visible)
    }

    @JvmStatic
    fun shouldShowOosQsLayout(context: Context): Boolean {
        return isOosQsLayoutEnabled(context) &&
