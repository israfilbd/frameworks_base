...
public class NetworkTraffic extends TextView implements TunerService.Tunable {
    ...
    private NetworkCallback defaultNetworkCallback;
    ...
    protected void onAttachedToWindow() {
		...
		Log.e("NetworkTraffic", "Exception: " + e.getMessage());
	    }
    ...
    protected void onDetachedFromWindow() {
		...
		if (isNetworkCallbackRegistered) {
		    ...
		    mConnectivityManager.unregisterNetworkCallback(defaultNetworkCallback);
		    isNetworkCallbackRegistered = false;
		}
	    } catch (IllegalArgumentException e) {
	        Log.e("NetworkTraffic", "Callback already unregistered or never registered: " + e.getMessage());
	    }
            mAttached = false;
        }
    }
