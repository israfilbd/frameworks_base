...
public class FlingAnimationUtils {
    ...
    private static final float LINEAR_OUT_SLOW_IN_X2 = 0.4f;
    private static final float LINEAR_OUT_SLOW_IN_X2_MAX = 0.75f;
    private static final float LINEAR_OUT_FASTER_IN_X2 = 0.6f;
    private static final float LINEAR_OUT_FASTER_IN_Y2_MIN = 0.5f;
    private static final float LINEAR_OUT_FASTER_IN_Y2_MAX = 0.6f;
    private static final float MIN_VELOCITY_DP_PER_SECOND = 200;
    private static final float HIGH_VELOCITY_DP_PER_SECOND = 2500;

    private static final float LINEAR_OUT_SLOW_IN_START_GRADIENT = 0.8f;
